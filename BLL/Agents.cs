...
namespace yny_003.BLL
{
    ...
    {
        private readonly yny_003.DAL.Agents dal = new yny_003.DAL.Agents();
        public Agents()
        { }
        #region  BasicMethod
        ...
        /// 增加一条数据
        /// </summary>
        public static bool Add(yny_003.Model.Agents model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(yny_003.Model.Agents model)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public static yny_003.Model.Agents GetModel(int ID)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public static List<yny_003.Model.Agents> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public static yny_003.Model.Agents GetModel(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public static List<yny_003.Model.Agents> DataTableToList(DataTable dt)
        {
            List<yny_003.Model.Agents> modelList = new List<yny_003.Model.Agents>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                yny_003.Model.Agents model;
