...
namespace yny_003.BLL
{
    public class BMember
    {
        ...
        public static yny_003.Model.BMember GetModel(string obj)
        {
            return yny_003.DAL.BMember.GetModel(obj);
        }
        ...
        public static System.Collections.Hashtable Insert(yny_003.Model.BMember model, System.Collections.Hashtable MyHs)
        {
            DAL.BMember.tempBMemberList.Add(model);
            return yny_003.DAL.BMember.Insert(model, MyHs);
        }

        public static bool Insert(yny_003.Model.BMember model)
        {
            lock (obj)
            {
        ...
        public static System.Collections.Hashtable Update(yny_003.Model.BMember model, System.Collections.Hashtable MyHs)
        {
            return yny_003.DAL.BMember.Update(model, MyHs);
        }

        public static bool Update(yny_003.Model.BMember model)
        {
            return yny_003.DAL.BMember.Update(model);
        }

        public static System.Collections.Hashtable Delete(object obj, System.Collections.Hashtable MyHs)
        {
            return yny_003.DAL.BMember.Delete(obj, MyHs);
        }

        public static bool Delete(object obj)
        {
            return yny_003.DAL.BMember.Delete(obj);
        }

        public static System.Data.DataTable GetTable(string strWhere)
        {
            return yny_003.DAL.BMember.GetTable(strWhere);
        }

        public static System.Data.DataTable GetTable(string strWhere, int pageIndex, int pageSize, out int count)
        {
            return yny_003.DAL.BMember.GetTable(strWhere, pageIndex, pageSize, out count);
        }

        public static List<yny_003.Model.BMember> GetList(string strWhere)
        {
            return yny_003.DAL.BMember.GetList(strWhere);
        }
        public static List<yny_003.Model.BMember> GetList(int top, string strWhere)
        {
            return yny_003.DAL.BMember.GetList(top, strWhere);
        }

        public static List<yny_003.Model.BMember> GetList(string strWhere, int pageIndex, int pageSize, out int count)
        {
            return yny_003.DAL.BMember.GetList(strWhere, pageIndex, pageSize, out count, "BMID DESC");
        }

        public static string GetBMID(Model.Member model)
        {
            return yny_003.DAL.BMember.GetBMID(model);
        }
    }
}
