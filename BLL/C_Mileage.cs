...
namespace yny_003.BLL
{
	...
	{
		private readonly yny_003.DAL.C_Mileage dal=new yny_003.DAL.C_Mileage();
		public C_Mileage()
		{}
		#region  BasicMethod
        ...
        /// 增加一条数据
        /// </summary>
        public static int  Add(yny_003.Model.C_Mileage model)
		{
        ...
        /// 更新一条数据
        /// </summary>
        public static bool Update(yny_003.Model.C_Mileage model)
		{
        ...
        public static List<Model.C_Mileage> GetList(string strWhere, int pageIndex, int pageSize, out int count)
        {
            return DAL.C_Mileage.GetList(strWhere, pageIndex, pageSize, out count);
        }

        /// <summary>
        /// 获得数据列表
        /// </summary>
        public static List<yny_003.Model.C_Mileage> GetModelList(string strWhere)
		{
        ...
        /// 获得数据列表
        /// </summary>
        public static List<yny_003.Model.C_Mileage> DataTableToList(DataTable dt)
		{
			List<yny_003.Model.C_Mileage> modelList = new List<yny_003.Model.C_Mileage>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				yny_003.Model.C_Mileage model;
