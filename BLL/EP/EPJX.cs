...
namespace yny_003.BLL
{
    ...
    public class EPJX
    {
        public static yny_003.Model.EPJX GetModel(object obj)
        {
            return yny_003.DAL.EPJX.GetModel(obj);
        }

        public static Hashtable Insert(yny_003.Model.EPJX model, Hashtable MyHs)
        {
            return yny_003.DAL.EPJX.Insert(model, MyHs);
        }

        public static bool Insert(yny_003.Model.EPJX model)
        {
            return yny_003.DAL.EPJX.Insert(model);
        }

        public static Hashtable Update(yny_003.Model.EPJX model, Hashtable MyHs)
        {
            return yny_003.DAL.EPJX.Update(model, MyHs);
        }

        public static bool Update(yny_003.Model.EPJX model)
        {
            return yny_003.DAL.EPJX.Update(model);
        }

        public static Hashtable Delete(object obj, Hashtable MyHs)
        {
            return yny_003.DAL.EPJX.Delete(obj, MyHs);
        }

        public static bool Delete(object obj)
        {
            return yny_003.DAL.EPJX.Delete(obj);
        }

        public static DataTable GetTable(string strWhere)
        {
            return yny_003.DAL.EPJX.GetTable(strWhere);
        }

        public static DataTable GetTable(string strWhere, int pageIndex, int pageSize, out int count)
        {
            return yny_003.DAL.EPJX.GetTable(strWhere, pageIndex, pageSize, out count);
        }

        public static List<yny_003.Model.EPJX> GetList(string strWhere)
        {
            return yny_003.DAL.EPJX.GetList(strWhere);
        }

        public static List<yny_003.Model.EPJX> GetList(string strWhere, int pageIndex, int pageSize, out int count)
        {
            return yny_003.DAL.EPJX.GetList(strWhere, pageIndex, pageSize, out count);
        }
