...
namespace yny_003.BLL
{
    ...
    public class EPList
    {
        public static yny_003.Model.EPList GetModel(object obj)
        {
            return yny_003.DAL.EPList.GetModel(obj);
        }

        public static Hashtable Insert(yny_003.Model.EPList model, Hashtable MyHs)
        {
            return yny_003.DAL.EPList.Insert(model, MyHs);
        }

        public static string Insert(yny_003.Model.EPList model)
        {
        ...
        public static Hashtable Update(yny_003.Model.EPList model, Hashtable MyHs)
        {
            return yny_003.DAL.EPList.Update(model, MyHs);
        }

        public static bool Update(yny_003.Model.EPList model)
        {
            return yny_003.DAL.EPList.Update(model);
        }

        public static Hashtable Delete(object obj, Hashtable MyHs)
        {
            return yny_003.DAL.EPList.Delete(obj, MyHs);
        }

        public static bool Delete(object obj)
        {
            return yny_003.DAL.EPList.Delete(obj);
        }

        public static DataTable GetTable(string strWhere)
        {
            return yny_003.DAL.EPList.GetTable(strWhere);
        }

        public static DataTable GetTable(string strWhere, int pageIndex, int pageSize, out int count)
        {
            return yny_003.DAL.EPList.GetTable(strWhere, pageIndex, pageSize, out count);
        }

        public static List<yny_003.Model.EPList> GetList(string strWhere)
        {
            return yny_003.DAL.EPList.GetList(strWhere);
        }

        public static List<yny_003.Model.EPList> GetList(string strWhere, int pageIndex, int pageSize, out int count)
        {
            return yny_003.DAL.EPList.GetList(strWhere, pageIndex, pageSize, out count);
        }
