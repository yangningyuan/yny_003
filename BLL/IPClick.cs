...
namespace yny_003.BLL
{
    ...
    public class IPClick
    {
        ...
        {
            return yny_003.DAL.IPClick.GetModel(obj);
        }

        public static Hashtable Insert(Model.IPClick model, Hashtable MyHs)
        {
            return yny_003.DAL.IPClick.Insert(model, MyHs);
        }

        public static bool Insert(Model.IPClick model)
        {
            return yny_003.DAL.IPClick.Insert(model);
        }

        public static Hashtable Update(Model.IPClick model, Hashtable MyHs)
        {
            return yny_003.DAL.IPClick.Update(model, MyHs);
        }

        public static bool Update(Model.IPClick model)
        {
            return yny_003.DAL.IPClick.Update(model);
        }

        public static Hashtable Delete(object obj, Hashtable MyHs)
        {
            return yny_003.DAL.IPClick.Delete(obj, MyHs);
        }

        public static bool Delete(object obj)
        {
            return yny_003.DAL.IPClick.Delete(obj);
        }

        public static DataTable GetTable(string strWhere)
        {
            return yny_003.DAL.IPClick.GetTable(strWhere);
        }

        public static DataTable GetTable(string strWhere, int pageIndex, int pageSize, out int count)
        {
            return yny_003.DAL.IPClick.GetTable(strWhere, pageIndex, pageSize, out count);
        }

        public static List<Model.IPClick> GetList(string strWhere)
        {
            return yny_003.DAL.IPClick.GetList(strWhere);
        }

        public static List<Model.IPClick> GetList(string strWhere, int pageIndex, int pageSize, out int count)
        {
            return yny_003.DAL.IPClick.GetList(strWhere, pageIndex, pageSize, out count);
        }
