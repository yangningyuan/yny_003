...
namespace yny_003.BLL
{
    ...
    {
        private readonly yny_003.DAL.JoggleLogin dal = new yny_003.DAL.JoggleLogin();
        public JoggleLogin()
        { }
        #region  BasicMethod
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(yny_003.Model.JoggleLogin model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(yny_003.Model.JoggleLogin model)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public yny_003.Model.JoggleLogin GetModel(int ID)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<yny_003.Model.JoggleLogin> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<yny_003.Model.JoggleLogin> DataTableToList(DataTable dt)
        {
            List<yny_003.Model.JoggleLogin> modelList = new List<yny_003.Model.JoggleLogin>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                yny_003.Model.JoggleLogin model;
