...
namespace yny_003.BLL
{
    ...
    {
        private readonly yny_003.DAL.LotteryDraw dal = new yny_003.DAL.LotteryDraw();
        public LotteryDraw()
        { }
        #region  BasicMethod
        ...
        /// 增加一条数据
        /// </summary>
        public static bool Add(yny_003.Model.LotteryDraw model)
        {
        ...
        /// 增加一条数据
        /// </summary>
        public static Hashtable Add(yny_003.Model.LotteryDraw model, Hashtable MyHs)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(yny_003.Model.LotteryDraw model)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public yny_003.Model.LotteryDraw GetModel(int ID)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<yny_003.Model.LotteryDraw> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<yny_003.Model.LotteryDraw> DataTableToList(DataTable dt)
        {
            List<yny_003.Model.LotteryDraw> modelList = new List<yny_003.Model.LotteryDraw>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                yny_003.Model.LotteryDraw model;
        ...
        public static List<yny_003.Model.LotteryDraw> GetList(string strWhere, int pageIndex, int pageSize, out int count)
        {
            return yny_003.DAL.LotteryDraw.GetList(strWhere, pageIndex, pageSize, out count);
        }
        ...
        {
            yny_003.DAL.LotteryDraw dall = new yny_003.DAL.LotteryDraw();
