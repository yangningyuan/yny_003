...
namespace yny_003.BLL
{
    ...
    {
        private readonly yny_003.DAL.LuckyMoney dal = new yny_003.DAL.LuckyMoney();
        public LuckyMoney()
        { }
        #region  BasicMethod
        ...
        /// 增加一条数据
        /// </summary>
        public static bool Add(yny_003.Model.LuckyMoney model)
        {
        ...
        /// 增加一条数据
        /// </summary>
        public static Hashtable Add(yny_003.Model.LuckyMoney model, Hashtable MyHs)
        {
            return DAL.LuckyMoney.Add(model, MyHs);
        }
        ...
        /// 更新一条数据
        /// </summary>
        public static Hashtable Update(yny_003.Model.LuckyMoney model, Hashtable MyHs)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public static yny_003.Model.LuckyMoney GetModel(int ID)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public static yny_003.Model.LuckyMoney GetModel(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public static List<yny_003.Model.LuckyMoney> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public static List<yny_003.Model.LuckyMoney> DataTableToList(DataTable dt)
        {
            List<yny_003.Model.LuckyMoney> modelList = new List<yny_003.Model.LuckyMoney>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                yny_003.Model.LuckyMoney model;
