...
namespace yny_003.BLL
{
    ...
    {
        private readonly yny_003.DAL.QuitRecord dal = new yny_003.DAL.QuitRecord();
        public QuitRecord()
        { }
        #region  BasicMethod
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(yny_003.Model.QuitRecord model)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public yny_003.Model.QuitRecord GetModel(string ID)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<yny_003.Model.QuitRecord> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<yny_003.Model.QuitRecord> DataTableToList(DataTable dt)
        {
            List<yny_003.Model.QuitRecord> modelList = new List<yny_003.Model.QuitRecord>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                yny_003.Model.QuitRecord model;
        ...
        public static bool CreateQuit(Model.Member member)
        {
            ...
            return new yny_003.DAL.QuitRecord().Add(quit) > 0;
        }

        public static List<yny_003.Model.QuitRecord> GetList(string strWhere, int pageIndex, int pageSize, out int count)
        {
            return yny_003.DAL.QuitRecord.GetList(strWhere, pageIndex, pageSize, out count);
        }
