...
namespace yny_003.BLL
{
    ...
    public class GoodCategory
    {
        ...
        {
            return yny_003.DAL.GoodCategory.GetModel(obj);
        }
        public static Model.GoodCategory GetModelByCode(object obj)
        {
            return yny_003.DAL.GoodCategory.GetModelByCode(obj);
        }
        ...
        {
            return yny_003.DAL.GoodCategory.Delete(obj, MyHs);
        }

        public static bool Delete(object obj)
        {
            return yny_003.DAL.GoodCategory.Delete(obj);
        }

        public static DataTable GetTable(string strWhere)
        {
            return yny_003.DAL.GoodCategory.GetTable(strWhere);
        }

        public static DataTable GetTable(string strWhere, int pageIndex, int pageSize, out int count)
        {
            return yny_003.DAL.GoodCategory.GetTable(strWhere, pageIndex, pageSize, out count);
        }

        public static List<Model.GoodCategory> GetList(string strWhere)
        {
            return yny_003.DAL.GoodCategory.GetList(strWhere);
        }

        public static List<Model.GoodCategory> GetList(string strWhere, int pageIndex, int pageSize, out int count)
        {
            return yny_003.DAL.GoodCategory.GetList(strWhere, pageIndex, pageSize, out count);
        }
    }
}
