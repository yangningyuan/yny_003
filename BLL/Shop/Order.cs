...
namespace yny_003.BLL
{
    public class Order
    {
        ...
        {
            return yny_003.DAL.Order.Insert(model);
        }

        public static Hashtable Update(Model.Order model, Hashtable MyHs)
        {
            return yny_003.DAL.Order.Update(model, MyHs);
        }

        public static bool Update(Model.Order model)
        {
            return yny_003.DAL.Order.Update(model);
        }

        public static Hashtable Delete(object obj, Hashtable MyHs)
        {
            return yny_003.DAL.Order.Delete(obj, MyHs);
        }

        public static bool Delete(object obj)
        {
            return yny_003.DAL.Order.Delete(obj);
        }

        public static DataTable GetTable(string strWhere)
        {
            return yny_003.DAL.Order.GetTable(strWhere);
        }

        public static DataTable GetTable(string strWhere, int pageIndex, int pageSize, out int count)
        {
            return yny_003.DAL.Order.GetTable(strWhere, pageIndex, pageSize, out count);
        }

        public static List<Model.Order> GetList(string strWhere)
        {
            return yny_003.DAL.Order.GetList(strWhere);
        }

        public static List<Model.Order> GetList(string strWhere, int pageIndex, int pageSize, out int count)
        {
            return yny_003.DAL.Order.GetList(strWhere, pageIndex, pageSize, out count);
        }
