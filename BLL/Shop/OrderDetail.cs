...
namespace yny_003.BLL
{
    ...
    public class OrderDetail
    {
        ...
        {
            return yny_003.DAL.OrderDetail.Insert(model);
        }

        public static Hashtable Update(Model.OrderDetail model, Hashtable MyHs)
        {
            return yny_003.DAL.OrderDetail.Update(model, MyHs);
        }

        public static bool Update(Model.OrderDetail model)
        {
            return yny_003.DAL.OrderDetail.Update(model);
        }

        public static Hashtable Delete(object obj, Hashtable MyHs)
        {
            return yny_003.DAL.OrderDetail.Delete(obj, MyHs);
        }

        public static bool Delete(object obj)
        {
            return yny_003.DAL.OrderDetail.Delete(obj);
        }

        public static DataTable GetTable(string strWhere)
        {
            return yny_003.DAL.OrderDetail.GetTable(strWhere);
        }

        public static DataTable GetTable(string strWhere, int pageIndex, int pageSize, out int count)
        {
            return yny_003.DAL.OrderDetail.GetTable(strWhere, pageIndex, pageSize, out count);
        }

        public static List<Model.OrderDetail> GetList(string strWhere)
        {
            return yny_003.DAL.OrderDetail.GetList(strWhere);
        }

        public static List<Model.OrderDetail> GetList(string strWhere, int pageIndex, int pageSize, out int count)
        {
            return yny_003.DAL.OrderDetail.GetList(strWhere, pageIndex, pageSize, out count);
        }
    }
}
