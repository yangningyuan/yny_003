...
namespace yny_003.BLL
{
    ...
    public class ReceiveInfo
    {
        ...
        {
            return yny_003.DAL.ReceiveInfo.GetModel(obj);
        }
        ...
        {
            return yny_003.DAL.ReceiveInfo.Delete(obj, MyHs);
        }

        public static bool Delete(object obj)
        {
            return yny_003.DAL.ReceiveInfo.Delete(obj);
        }

        public static DataTable GetTable(string strWhere)
        {
            return yny_003.DAL.ReceiveInfo.GetTable(strWhere);
        }

        public static DataTable GetTable(string strWhere, int pageIndex, int pageSize, out int count)
        {
            return yny_003.DAL.ReceiveInfo.GetTable(strWhere, pageIndex, pageSize, out count);
        }

        public static List<Model.ReceiveInfo> GetList(string strWhere)
        {
            return yny_003.DAL.ReceiveInfo.GetList(strWhere);
        }

        public static List<Model.ReceiveInfo> GetList(string strWhere, int pageIndex, int pageSize, out int count)
        {
            return yny_003.DAL.ReceiveInfo.GetList(strWhere, pageIndex, pageSize, out count);
        }
