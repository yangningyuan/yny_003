...
namespace yny_003.BLL
{
    ...
    {
        private readonly yny_003.DAL.StockRight dal = new yny_003.DAL.StockRight();
        public StockRight()
        { }
        #region  BasicMethod
        ...
        /// 得到一个对象实体
        /// </summary>
        public yny_003.Model.StockRight GetModel(int ID)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public static List<yny_003.Model.StockRight> GetModelList(int Top, string strWhere, string filedOrder)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<yny_003.Model.StockRight> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public static List<yny_003.Model.StockRight> DataTableToList(DataTable dt)
        {
            List<yny_003.Model.StockRight> modelList = new List<yny_003.Model.StockRight>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                yny_003.Model.StockRight model;
