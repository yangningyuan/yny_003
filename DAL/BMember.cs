...
namespace yny_003.DAL
{
    public class BMember
    {
        ...
        /// 增加一条数据
        /// </summary>
        public static Hashtable Insert(yny_003.Model.BMember model, Hashtable MyHs)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public static Hashtable Update(yny_003.Model.BMember model, Hashtable MyHs)
        {
            string guid = Guid.NewGuid().ToString();
            StringBuilder strSql = new StringBuilder();
        ...
        /// 得到一个对象实体
        /// </summary>
        public static yny_003.Model.BMember GetModel(string BMID)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        private static yny_003.Model.BMember DataRowToModel(DataRow row)
        {
            if (row != null)
            {
                yny_003.Model.BMember model = new yny_003.Model.BMember();
                if (row["ID"].ToString() != "")
                {
        ...
        {
            List<yny_003.Model.BMember> list = new List<yny_003.Model.BMember>();
        ...
        /// 获得前几行数据
        /// </summary>
        public static List<yny_003.Model.BMember> GetList(string strWhere, int pageIndex, int pageSize, out int count, string orderBy)
        {
            List<yny_003.Model.BMember> list = new List<yny_003.Model.BMember>();
