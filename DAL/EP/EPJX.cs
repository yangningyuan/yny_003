...
namespace yny_003.DAL
{
    ...
    public class EPJX
    {
        ...
        /// 得到一个对象实体
        /// </summary>
        public static yny_003.Model.EPJX GetModel(object JXID)
        {
        ...
        {
            List<yny_003.Model.EPJX> list = new List<yny_003.Model.EPJX>();
        ...
        /// 获得实体列表
        /// </summary>
        public static List<yny_003.Model.EPJX> GetList(int top, string strWhere)
        {
            List<yny_003.Model.EPJX> list = new List<yny_003.Model.EPJX>();
        ...
        ///  实体转换
        /// <summary>
        private static yny_003.Model.EPJX TranEntity(DataRow dr)
        {
            if (dr != null)
            {
                yny_003.Model.EPJX model = new yny_003.Model.EPJX();
