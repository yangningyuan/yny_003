...
namespace yny_003.DAL
{
    ...
    public class EPList
    {
        ...
        /// 得到一个对象实体
        /// </summary>
        public static yny_003.Model.EPList GetModel(object EPID)
        {
        ...
        /// 增加一条数据
        /// </summary>
        public static bool Insert(yny_003.Model.EPList model)
        {
        ...
        {
            List<yny_003.Model.EPList> list = new List<yny_003.Model.EPList>();
        ...
        /// 获得实体列表
        /// </summary>
        public static List<yny_003.Model.EPList> GetList(int top, string strWhere)
        {
            List<yny_003.Model.EPList> list = new List<yny_003.Model.EPList>();
        ...
        ///  实体转换
        /// <summary>
        private static yny_003.Model.EPList TranEntity(DataRow row)
        {
            if (row != null)
            {
                yny_003.Model.EPList model = new yny_003.Model.EPList();
