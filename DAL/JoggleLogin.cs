...
namespace yny_003.DAL
{
    ...
    public partial class JoggleLogin
    {
        ...
        public yny_003.Model.JoggleLogin GetModel(int ID)
        {
            ...
            yny_003.Model.JoggleLogin model = new yny_003.Model.JoggleLogin();
        ...
        /// 得到一个对象实体
        /// </summary>
        public yny_003.Model.JoggleLogin GetModelByMID(string mid, string time)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 ID,MID,Code,Createtime,isValid from JoggleLogin ");
        ...
        /// 得到一个对象实体
        /// </summary>
        public yny_003.Model.JoggleLogin DataRowToModel(DataRow row)
        {
            yny_003.Model.JoggleLogin model = new yny_003.Model.JoggleLogin();
            if (row != null)
            {
