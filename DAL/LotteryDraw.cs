...
namespace yny_003.DAL
{
    ...
    public partial class LotteryDraw
    {
        ...
        /// 更新一条数据
        /// </summary>
        public static bool Update(yny_003.Model.LotteryDraw model)
        {
            return CommonBase.RunHashtable(Update(model, new Hashtable()));
        }

        public static Hashtable Update(yny_003.Model.LotteryDraw model, Hashtable MyHs)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public yny_003.Model.LotteryDraw GetModel(int ID)
        {
            ...
            yny_003.Model.LotteryDraw model = new yny_003.Model.LotteryDraw();
        ...
        /// 得到一个对象实体
        /// </summary>
        public static yny_003.Model.LotteryDraw DataRowToModel(DataRow row)
        {
            yny_003.Model.LotteryDraw model = new yny_003.Model.LotteryDraw();
            if (row != null)
            {
        ...
        {
            List<yny_003.Model.LotteryDraw> list = new List<yny_003.Model.LotteryDraw>();
        ...
        public static Model.LotteryDraw RobDraw(string mid)
        {
            ...
            yny_003.Model.LotteryDraw model = null;
