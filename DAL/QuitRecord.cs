...
namespace yny_003.DAL
{
    ...
    public partial class QuitRecord
    {
        ...
        public static Hashtable Update(yny_003.Model.QuitRecord model, Hashtable MyHs)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public yny_003.Model.QuitRecord GetModel(string ID)
        {
            ...
            yny_003.Model.QuitRecord model = new yny_003.Model.QuitRecord();
        ...
        /// 得到一个对象实体
        /// </summary>
        public static yny_003.Model.QuitRecord DataRowToModel(DataRow row)
        {
            yny_003.Model.QuitRecord model = new yny_003.Model.QuitRecord();
            if (row != null)
            {
        ...
        {
            List<yny_003.Model.QuitRecord> list = new List<yny_003.Model.QuitRecord>();
