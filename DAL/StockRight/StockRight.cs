...
namespace yny_003.DAL
{
    ...
    public partial class StockRight
    {
        ...
        public static Hashtable Add(yny_003.Model.StockRight model, Hashtable MyHs)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 增加一条数据
        /// </summary>
        public bool Add(yny_003.Model.StockRight model)
        {
            return CommonBase.RunHashtable(Add(model, new Hashtable()));
        }

        public static Hashtable Update(yny_003.Model.StockRight model, Hashtable MyHs)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 得到一个对象实体
        /// </summary>
        public static yny_003.Model.StockRight GetModel(int ID)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            yny_003.Model.StockRight model = new yny_003.Model.StockRight();
        ...
        /// 得到一个对象实体
        /// </summary>
        public static yny_003.Model.StockRight DataRowToModel(DataRow row)
        {
            yny_003.Model.StockRight model = new yny_003.Model.StockRight();
            if (row != null)
            {
        ...
        /// 获得实体列表
        /// </summary>
        public static List<yny_003.Model.StockRight> GetList(string strWhere, int pageIndex, int pageSize, out int count)
        {
            List<yny_003.Model.StockRight> list = new List<yny_003.Model.StockRight>();
