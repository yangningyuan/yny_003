...
namespace yny_003.DAL
{
    ...
    public partial class StockRightConfig
    {
        ...
        /// 得到一个对象实体
        /// </summary>
        public static yny_003.Model.StockRightConfig DataRowToModel(DataRow row)
        {
            yny_003.Model.StockRightConfig model = new yny_003.Model.StockRightConfig();
            if (row != null)
            {
                if (row["Code"] != null)
                {
        ...
        /// 增加一条数据
        /// </summary>
        public static Hashtable Add(yny_003.Model.StockRightConfig model, Hashtable MyHs)
        {
            StringBuilder strSql = new StringBuilder();
