<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="downjiezhang2.aspx.cs" Inherits="yny_003.Web.Car.downjiezhang2" %>
                    ...
                    <table cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td width="24%" style="height: 40px;">
                             ...
                             <td width="24%" align="right"  id="fkview">请选择收款卡
                            </td>
                            <td width="24%" >
    ...
    <script>
        function subaccChange() {
            if ($('#UserName').val() == '') {
                ...
                $.ajax({
                    type: 'post',
                    url: '/car/downjiezhang2.aspx?Action=Modify',
