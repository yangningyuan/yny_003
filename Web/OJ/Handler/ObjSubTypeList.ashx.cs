...
{
    /// <summary>
    /// ObjSubTypeList 的摘要说明
    /// </summary>
    public class ObjSubTypeList : BaseHandler
    {
        ...
        public override void ProcessRequest(HttpContext context)
        {
            ...
            //}
            int count;
            List<Model.ObjSubType> ListNotice = BLL.ObjSubType.GetList(strWhere, pageIndex, pageSize, out count);
