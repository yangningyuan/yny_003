<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DelCar.aspx.cs" Inherits="yny_003.Web.mobile.html.DelCar" %>
        ...
        <form id="form1">
            ...
            <ul>
                ...
                <li>
                    <div class="item-content">
                        <div class="item-inner">
                            <div class="item-title label">交车车辆里程</div>
                            <div class="item-input">
                                 <input type="text" value="" name="txtMileage" id="txtMileage" runat="server"  placeholder="请输入交车时车辆里程" >
                            </div>
                        </div>
                    </div>
                </li>
    ...
    <div class="content-block">
        <div class="row">
            <div class="col-100" id="btnhtml" runat="server">
                <a href="javascript:checkChange();" class="button button-big button-fill button-success">交车确认</a>
            </div>
        </div>
    </div>
</div>
<script type="text/javascript">
    function checkChange() {
        if ($('#txtCarCode').val().trim() == "") {
            ...
            ActionModel("mobile/html/DelCar.aspx?Action=add", $('#form1').serialize(), "mobile/html/DelCar.aspx");
        }
    }
</script>