<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvestList.aspx.cs" Inherits="yny_003.Web.mobile.html.InvestList" %>
...
<script type="text/javascript">
    setTimeout(function () {
        $('#page_container').Paging({
            ...
            DataUrl: '/mobile/html/InvestList.aspx?Action=Other',
